#!/bin/bash
#SBATCH -J show-snps_UoQTHILLE			# jobname
#SBATCH -o show-snps_UoQTHILLE.o%A.%a		# jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e show-snps_UoQTHILLE.e%A.%a		# error file name A is the jobid and a is the arraytaskid
