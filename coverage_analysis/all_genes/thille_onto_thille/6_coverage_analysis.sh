...
#SBATCH -a 2-30		# start and stop of the array start-end
#SBATCH -A mcb180013p
#SBATCH --nodes=1
...
gene_bed='../gwen_onto_thille/gwen_genes_thille.bed'
...
awk -v cm=${chromosome} '{ if($1 == cm) print $3 }' cov.txt > temp_coverage_${chromosome}.txt
