...
def plot_cumulative_sum(files, output_file):
    ...
    for file_path in files:
        ...
        plt.plot(num_fragments, [x / 1000000 for x in cumulative_sum], label=os.path.basename(file_path))
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(current_dir, "cumulative_sum_graph2.pdf")
