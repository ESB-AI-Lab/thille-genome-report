#!/bin/bash
#SBATCH -J 2_sbatch_get_sorted_bam		# jobname
...
python3 cumulativesum2.py gwen.hapsolo.contigs.primary.lengths thille.hifiv3.asm.p_ctg.masked.lengths UoQ_sorted_contigLengths2.txt UoQ_sorted_scaffold_lengths.txt
