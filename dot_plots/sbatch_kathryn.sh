...
# Run Minimap2
# PATH=/jet/home/kac012/bin/minimap2-2.24_x64-linux:$PATH
#minimap2 -cx asm5 -t 4 "$REF" "$QRY" > "$OUTPUT_SAM"

# Execute the Python script for dot plot generation
/jet/packages/anaconda3-2022.10/bin/python3 kathryn.py "$REF" "$QRY" "$LENGTHS_FILE" "$OUTPUT_PAF" "$Thille_SNP_FILE"
