#!/bin/bash
#SBATCH -J show-coords_GWENTHILLE			# jobname
#SBATCH -o show-coords_GWENTHILLE.o%A.%a		# jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e show-coords_GWENTHILLE.e%A.%a		# error file name A is the jobid and a is the arraytaskid
