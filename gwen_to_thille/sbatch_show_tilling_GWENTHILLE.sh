#!/bin/bash
#SBATCH -J show-tiling_GWENTHILLE			# jobname
#SBATCH -o show-tiling_GWENTHILLE.o%A.%a		# jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e show-tiling_GWENTHILLE.e%A.%a		# error file name A is the jobid and a is the arraytaskid
...
show-tiling -x ${REF_QRY}.delta > ${REF_QRY}.delta.x.txt
