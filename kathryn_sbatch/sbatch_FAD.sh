#!/bin/bash
#SBATCH -J FAD		# jobname
#SBATCH -o FAD.o%A.%a	# jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e FAD.e%A.%a	# error file name A is the jobid and a is the arraytaskid
...
REF=hass.hifi.pooled.asm.p_ctg.masked.fasta # database
...
minimap2 -ax splice $REF $QRY > $BASENAME.sam
